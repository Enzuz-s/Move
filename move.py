...
move_dir = "C:\\Users\\" + USER + "\\Desktop\\moved"

destination_dir_sfx = os.path.join(move_dir, "Downloads-sfx")
destination_dir_txt = os.path.join(move_dir, "Downloads-txt")
destination_dir_music = os.path.join(move_dir, "Downloads-music")
destination_dir_video = os.path.join(move_dir, "Downloads-video")
destination_dir_image = os.path.join(move_dir, "Downloads-image")
destination_dir_exe = os.path.join(move_dir, "Downloads-exe")
destination_dir_office = os.path.join(move_dir, "Downloads-office")
destination_dir_3d_printer = os.path.join(move_dir, "Downloads-3d-printer")
destination_dir_arch_comp = os.path.join(move_dir, "Downloads-archive-compression")
...
basic_document_extensions = (".txt", ".log", ".json", ".md", ".pdf", ".pdfk")

exe_extensions = (".exe", ".msi", ".bat", ".cmd", ".com", ".vbs", ".vbe", ".js", ".jse", ".wsf", ".wsh", ".ini", ".inf")
